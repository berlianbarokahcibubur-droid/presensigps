...
class PresensiController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // VALIDASI
        // =========================
        if (!$image) return "error|Image kosong|";
        if (!$lokasi) return "error|Lokasi kosong|";

        $lokasiuser = explode(",", $lokasi);

        if (count($lokasiuser) < 2) {
            return "error|Format lokasi salah|";
        }
        ...
        if ($radius > $lok_kantor->radius) {
            return "Maaf, Anda Berada Diluar Radius";
        }
        ...
        if (count($image_parts) < 2) {
            return "error|Format image salah|";
        }
        ...
        if ($cek) {
            ...
            $fileName = $nik . "-" . $tgl_presensi . "-out-" . time() . ".png";
        ...
        // ABSEN MASUK
        // =========================
        $fileName = $nik . "-" . $tgl_presensi . "-in-" . time() . ".png";
        ...
        return "error|Gagal insert data|";
    }
    ...
    public function cetaklaporan(Request $request)
{
    ...
    public function cetakrekap(Request $request){
        ...
        COUNT(presensi.nik) as total_hadir, SUM(IF(jam_in > "08:30:00",1,0)) as total_terlambat
        ')
    ...
    public function izinsakit(Request $request){
        ...
        $query->select('id', 'tgl_izin', 'izin.nik', 'nama_lengkap', 'jabatan', 'status', 'status_approved', 'keterangan');
...
public function batalkanizinsakit($id)
{
    ...
    if ($update) {
        return redirect()
            ->back()
            ->with([
                'success' => 'Approval berhasil dibatalkan'
            ]);
    } else {
        return redirect()
            ->back()
            ->with([
                'warning' => 'Approval gagal dibatalkan'
            ]);
    ...
    public function cekpengajuanizin(Request $request){
        ...
        $cek = DB::table('izin')->where('nik', $nik)->where('tgl_izin', $tgl_izin)->count();
        return $cek;
    }
}