    ...
    function selisih($jam_masuk, $jam_keluar)
{
  ...
  <section class="sheet padding-10mm">
    ...
    <table style="width: 100%">
        <tr>
            <td style="width: 30px">
                <img src="{{ asset('assets/img/logo-bbb.JPG') }}" width="70" height="70" alt="">
            </td>
            <td>
                <span id="title">
    ...
    <table class="tabelpresensi">
        ...
        <tr>
            ...
            <td>{{ $d->jam_in }}</td>
            <td><img src="{{ url($path_in) }}" width="50" alt=""></td>
            <td>{{ $d->jam_out != null ? $d->jam_out : 'Belum Absen' }}</td>
            <td>
                @if ($d->jam_out != null)
                <img src="{{ url($path_out) }}" width="50" alt="">
                @else
                <img src="{{ asset('assets/img/No Photo.JPG') }}" width="50" alt="">
                @endif   
            </td>
            <td>
                @if ($d->jam_in > '08:30')
