...
<div class="row">
        ...
        <div class="modal modal-blur fade" id="modalinputdepartemen" tabindex="-1" role="dialog" aria-hidden="true">
...
{{-- modal edit --}}
    <div class="modal modal-blur fade" id="modaleditdepartemen" tabindex="-1" role="dialog" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
...
<script>
    $(function(){
        $("#btnTambahDepartemen").click(function(){
            $("#modalinputdepartemen").modal("show");
        });
