        ...
        <div class="section" id="user-section">
            ...
            <div class="section mt-2" id="presence-section">
                ...
                <div id="rekappresensi">
                    <h3>Rekap Presensi {{ $namabulan[(int)$bulanini] }} Tahun {{ $tahunini }}</h3>
                    <div class="row">
                        <div class="col-3">
                            <div class="card">
                                <div class="card-body text-center" style="padding:12px 12px !important; line-height:0.8rem">
                                    ...
                                    <ion-icon name="accessibility-outline" style="font-size:1.4rem"; class="text-primary mb-1";></ion-icon>
                                    <br>
                        ...
                        <div class="col-3">
                            <div class="card">
                                <div class="card-body text-center" style="padding:12px 12px !important; line-height:0.8rem">
                                    ...
                                    <ion-icon name="newspaper-outline" style="font-size:1.4rem"; class="text-success mb-1";></ion-icon>
                                    <br>
                        ...
                        <div class="col-3">
                            <div class="card">
                                <div class="card-body text-center" style="padding:12px 12px !important; line-height:0.8rem">
                                    ...
                                    <ion-icon name="medkit-outline" style="font-size:1.4rem"; class="text-warning mb-1";></ion-icon>
                                    <br>
                        ...
                        <div class="col-3">
                            <div class="card">
                                <div class="card-body text-center" style="padding:12px 12px !important; line-height:0.8rem">
                                    ...
                                    <ion-icon name="alarm-outline" style="font-size:1.4rem"; class="text-danger mb-1";></ion-icon>
                                    <br>
                            ...
                            <ul class="listview image-listview">
                                @foreach ($leaderboard as $d)
                                    <li>
                                        ...
                                        <div class="me-2">
                                            <img src="assets/img/sample/avatar/avatar1.jpg" class="imaged w48 rounded-circle">
                                        </div>

                                        <div style="flex:1;">
                                    <div style="font-size:14px; font-weight:600;"> {{ $d->nama_lengkap }}</div>
